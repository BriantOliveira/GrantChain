...
/// @author Jaeson Booker updated from Solidity 4.2 to Solidity 6.1


/// @notice A factory contract for the main Funding contract
...
contract FundMe{
    ...
    constructor(string memory _firstName, string memory _lastName, string memory _desription, uint _amountNeeded, address payable _recipient) public {
